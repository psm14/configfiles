...
function M.setup(opts)
  ...
  -- Set up keymaps
  vim.keymap.set('n', opts.toggle_key or '<D-k>', aider_toggle, { desc = 'Toggle Aider terminal' })
  vim.keymap.set('t', opts.toggle_key or '<D-k>', '<C-\\><C-n>:lua require("aider-nvim").toggle()<CR>', { desc = 'Toggle Aider terminal' })
